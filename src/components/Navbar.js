...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`${
          bg ? "bg-opacity-90" : "bg-opacity-60"
        } px-8 py-4 mx-auto sm:max-w-xl md:max-w-full lg:w-full md:px-24 lg:px-8 top-0 fixed z-50 bg-gray-50 shadow-md `}
      >
        <div className="relative flex items-center justify-between px-24">
          <a
            ...
            aria-label="Company"
            title="Company"
            className="inline-flex items-center ml-4 text-red-400"
          >
            <svg
            ...
            <span className="ml-2 text-xl font-bold tracking-wide text-gray-600 uppercase">
              Photo <span className="text-red-500">Artistry</span>
            </span>
          </a>
