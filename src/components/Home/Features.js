  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
          <div className="lg:w-1/2">
            <h2 className="max-w-md mb-6 font-display text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none xl:max-w-lg">
              ...
              <div className="h-1  duration-300 w-1/2 origin-left transform bg-red-400 scale-x-10 group-hover:scale-x-50" />
            </h2>
          </div>
          <div className="lg:w-1/2">
      ...
      <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <Fade bottom>
          <div>
            <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-red-400">
              <svg
